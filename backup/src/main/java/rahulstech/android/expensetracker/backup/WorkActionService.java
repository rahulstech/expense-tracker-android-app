...
import static rahulstech.android.expensetracker.backup.BackupRestoreHelper.BACKUP_NOTIFICATION_ID;
import static rahulstech.android.expensetracker.backup.BackupRestoreHelper.BACKUP_WORK_TAG;
...
import static rahulstech.android.expensetracker.backup.NotificationHelper.NotificationArgs.NOTIFICATION_TYPE_SIMPLE;
...
public class WorkActionService extends Service {
    ...
    private void onStartAutoDelete() {
        ...
        AutoDeleteWork task = new AutoDeleteWork(this, successful -> {
            SettingsActivity.setNextAutoDeleteDate(this);
