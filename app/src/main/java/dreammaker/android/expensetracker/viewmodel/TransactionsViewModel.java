...
public class TransactionsViewModel extends BaseViewModel {
    ...
    public LiveData<PagedList<TransactionHistoryDisplayModel>> getTransactionsForPerson(long personId) {
        Log.i(TAG,"getTransactionsForPerson: "+personId);
        if (null == transactionHistoriesDisplayModelLiveData) {
            transactionHistoriesDisplayModelLiveData = new LivePagedListBuilder<>(transactionDao.getTransactionsForPerson(personId),50)
                    .build();
        }
        return transactionHistoriesDisplayModelLiveData;
    }
    */
    ...
    public static class FilterTransactionParams {
        ...
        public FilterTransactionParams addSelectedAccount(long id) {
            Account account = new Account();
            account.setAccountId(id);
            return addSelectedAccount(account);
        }
        ...
        public FilterTransactionParams addSelectedPerson(long id) {
            Person person = new Person();
            person.setPersonId(id);
            return addSelectedPerson(person);
        }
