    ...
    public void insertTransaction(final Transaction transaction){
        AppExecutor.getDiskOperationsExecutor().execute(() -> {
            ...
            try{
                ...
                notifyOperationCallback(Helper.ACTION_INSERT, success);
            }
        });
    }
    ...
    public void updateTransaction(final Transaction transaction){
        AppExecutor.getDiskOperationsExecutor().execute(() -> {
            ...
            try {
                ...
                notifyOperationCallback(Helper.ACTION_EDIT, success);
            }
        });
    }
        ...
        if (Check.isNonNull(transactions)) {
            AppExecutor.getDiskOperationsExecutor().execute(() -> {
                ...
                try {
                    ...
                    notifyOperationCallback(Helper.ACTION_DELETE, changes > 0, changes);
                }
            });
        }
    }
